	...
	<div class="span24">
		...
		<div class="span18 last">
			...
			<div id="list" class="list clearfix">
					<ul>
								<li>
									<a href="content/brandInfo.html">
										<img src="../upload/image/blank.gif" data-original="http://storage.shopxx.net/demo-image/3.0/brand/vimly.gif" />
										<span title="梵希蔓">梵希蔓</span>
									</a>
								</li>
								<li>
										<a href="content/brandInfo.html">
										<img src="../upload/image/blank.gif" data-original="http://storage.shopxx.net/demo-image/3.0/brand/eifini.gif" />
										<span title="伊芙丽">伊芙丽</span>
									</a>
								</li>
								<li>
									<a href="content/brandInfo.html">
										<img src="../upload/image/blank.gif" data-original="http://storage.shopxx.net/demo-image/3.0/brand/sentubila.gif" />
										<span title="尚都比拉">尚都比拉</span>
									</a>
								</li>
								<li>
										<a href="content/brandInfo.html">
										<img src="../upload/image/blank.gif" data-original="http://storage.shopxx.net/demo-image/3.0/brand/semir.gif" />
										<span title="森马">森马</span>
									</a>
								</li>
								<li>
									<a href="content/brandInfo.html">
										<img src="../upload/image/blank.gif" data-original="http://storage.shopxx.net/demo-image/3.0/brand/yishion.gif" />
										<span title="以纯">以纯</span>
									</a>
								</li>
								<li>
										<a href="content/brandInfo.html">
										<img src="../upload/image/blank.gif" data-original="http://storage.shopxx.net/demo-image/3.0/brand/lining.gif" />
										<span title="李宁">李宁</span>
									</a>
								</li>
								<li>
										<a href="content/brandInfo.html">
										<img src="../upload/image/blank.gif" data-original="http://storage.shopxx.net/demo-image/3.0/brand/nike.gif" />
										<span title="耐克">耐克</span>
									</a>
								</li>
								<li>
										<a href="content/brandInfo.html">
										<img src="../upload/image/blank.gif" data-original="http://storage.shopxx.net/demo-image/3.0/brand/adidas.gif" />
										<span title="阿迪达斯">阿迪达斯</span>
									</a>
								</li>
								<li>
									<a href="content/brandInfo.html">
										<img src="../upload/image/blank.gif" data-original="http://storage.shopxx.net/demo-image/3.0/brand/jackjones.gif" />
										<span title="Jack Jones">Jack Jones</span>
									</a>
								</li>
								<li>
										<a href="content/brandInfo.html">
										<img src="../upload/image/blank.gif" data-original="http://storage.shopxx.net/demo-image/3.0/brand/septwolves.gif" />
										<span title="七匹狼">七匹狼</span>
									</a>
								</li>
								<li>
										<a href="content/brandInfo.html">
										<img src="../upload/image/blank.gif" data-original="http://storage.shopxx.net/demo-image/3.0/brand/hengyuanxiang.gif" />
										<span title="恒源祥">恒源祥</span>
									</a>
								</li>
								<li>
									<a href="content/brandInfo.html">
										<img src="../upload/image/blank.gif" data-original="http://storage.shopxx.net/demo-image/3.0/brand/sundance.gif" />
										<span title="圣得西">圣得西</span>
									</a>
								</li>
								<li>
									<a href="content/brandInfo.html">
										<img src="../upload/image/blank.gif" data-original="http://storage.shopxx.net/demo-image/3.0/brand/maoren.gif" />
										<span title="猫人">猫人</span>
									</a>
								</li>
								<li>
										<a href="content/brandInfo.html">
										<img src="../upload/image/blank.gif" data-original="http://storage.shopxx.net/demo-image/3.0/brand/beijirong.gif" />
										<span title="北极绒">北极绒</span>
									</a>
								</li>
								<li>
									<a href="content/brandInfo.html">
										<img src="../upload/image/blank.gif" data-original="http://storage.shopxx.net/demo-image/3.0/brand/metersbonwe.gif" />
										<span title="美特斯·邦威">美特斯·邦威</span>
									</a>
								</li>
								<li>
										<a href="content/brandInfo.html">
										<img src="../upload/image/blank.gif" data-original="http://storage.shopxx.net/demo-image/3.0/brand/jeanswest.gif" />
										<span title="真维斯">真维斯</span>
									</a>
								</li>
								<li class="last">
									<a href="content/brandInfo.html">
										<img src="../upload/image/blank.gif" data-original="http://storage.shopxx.net/demo-image/3.0/brand/tonlion.gif" />
										<span title="唐狮">唐狮</span>
									</a>
								</li>
					</ul>
			</div>
