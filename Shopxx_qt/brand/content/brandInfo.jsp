...
BrandInfo bri=bdi.getOne(id);
 %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
	<title>Jack Jones - Powered By SHOP++</title>
...
<div class="headerAd">
	...
	<div class="span24">
		<div class="tagWrap">
			...
			<div class="search">
				<form id="productSearchForm" action="../../product/search.jsp" method="get">
		...
		<div class="span18 last">
			...
			<div class="top">
					<img src="<%=bri.getbLog() %>" alt="<%=bri.getbName() %>" />
				<strong><%=bri.getbName() %></strong>
					官方网站: <a href="<%=bri.getbUrl() %>" target="_blank"><%=bri.getbUrl() %></a>
			</div>
